   ...
   <div class="container-xxl bg-white p-0">
      ...
      <div class="container" >
         ...
         <div style="text-align:right;">
            <a href="/update"  style="display: inline-block; padding: 10px 20px; background-color: pink; color: white;  border-radius: 3px;"> 현재 위치 입력 완료 </a>         
         </div>
      </div>
   </div>
       ...
       var clickedLatlng;
        ...
        function sendAddressToServer(AddressData) {        
            ...
            fetch('/location', {
                   ...
                   body: JSON.stringify({
                      /* [document.querySelector("[name=${_csrf}]").getAttribute("name")]: document.querySelector("[name=${_csrf}]").getAttribute("value"), */
                         '_csrf' : csrfToken,
