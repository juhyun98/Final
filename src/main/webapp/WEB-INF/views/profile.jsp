...
<%--                             <div class="col-md-6">
                        ...
                        <div class="row gx-3 mb-3">    
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="inputLastName" name="phone" type="tel" placeholder="" value="${mvo.phone}">
                            </div>
                            <div class="col-md-6">
                                <label class="small mb-1" for="inputLocation">관심사</label>
                                <input class="form-control" id="inputLocation" name="interest" type="text" placeholder="" value="${mvo.interest}">
                            </div>
                        </div>
                        ...
                        <div class="row gx-3 mb-3">
                        	<div class="col-md-6">
                            	...
                            	<input class="form-control" id="inputEmailAddress" name="mbti" type="text" placeholder="" value="${mvo.mbti}">
                        	</div>
                            <div class="col-md-6">
                                <label class="small mb-1" for="inputPhone">학력</label>
                                <input class="form-control" id="inputPhone" name="school" type="text" placeholder="" value="${mvo.school}">
                            </div>
                        </div>
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="inputPhone" name="sport" type="text" placeholder="" value="${mvo.sport}">
                            </div>
                            <!-- Form Group (birthday)-->
                            <div class="col-md-6">
                                <label class="small mb-1" for="inputBirthday">흡연</label>
                                <input class="form-control" id="inputBirthday" type="text" name="smoking" placeholder="" value="${mvo.smoking}">
                            </div>
                        </div>
                        <div class="row gx-3 mb-3">
                            <!-- Form Group (phone number)-->
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="inputPhone" type="text" placeholder="" value="${mvo.drinking}">
                            </div>
                            <!-- Form Group (birthday)-->
                            <div class="col-md-6">
                                <label class="small mb-1" for="inputBirthday">직업</label>
                                <input class="form-control" id="inputBirthday" type="text" name="job" placeholder="" value="${mvo.job}">
                            </div>
                        </div>
                        <div class="col-md-12">
                        	<label class="small mb-1" for="inputBirthday">자기 소개</label>
	                        <textarea rows="5" class="form-control" style="resize: none; outline: none; width: 100%; max-width: 100%; height: auto;">${mvo.aboutme}</textarea>
                        </div>
                        <!-- Save changes button-->
                        <br>
