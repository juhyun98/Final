   ...
   <div class="container-xxl bg-white p-0">
      ...
      <div class="row">
         <div class="col-12 text-center">
            <h2 class="upload-text"> <i class="material-icons">file_upload</i> 프로필 사진을 등록해주세요</h2>
         </div>
      </div>
			    ...
			    <div class="row">
			        <div class="col-12 text-right">
			            <div class="d-flex justify-content-end align-items-center">
			                <h4 id="move" style="margin: 0; margin-right: 20px;">정보 입력 페이지로 이동</h4>
			                <a href="/update" class="btn btn-lg" style="background-color: pink; width: 40px; height: 40px; border-radius: 50%; display: flex; justify-content: center; align-items: center;">
