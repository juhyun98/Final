                ...
                <div class="card-body">
                        ...
                        <div class="row gx-3 mb-3">
                           <div class="col-md-6">
                                ...
                                <input class="form-control" id="age" name="age" type="number" value="${mvo.age}" required>
                            </div>
                           <div class="col-md-6">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="phone" name="phone" type="tel" value="${mvo.phone}" required>
                            </div>
                            <!-- Form Group (last name)-->
                            <div class="col-md-6">
                                <label class="small mb-1" for="inputLocation">관심사</label>
                                <input class="form-control" id="interest" name="interest" type="text" value="${mvo.interest}" required>
                            </div>
                        </div>
