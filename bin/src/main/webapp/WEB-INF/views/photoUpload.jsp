                  ...
                  <div class="card-body mt-3" >
                     ...
                     <c:forEach items="${imageDatas}" var="imageData" varStatus="i" >
                        <div class="responsive">
                           <div class="gallery"> 
                           <img src="data:image/jpeg;base64,${imageData}" alt="S3 Image" class="rounded" style="width:300px; height:350px; width: 100%; cursor: pointer;" onclick="openFileInput(${i.count})">
                                 <form action="${cpath}/fileUpload" method="post" enctype="multipart/form-data" id="imageForm${i.count}">
                                    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                    <input type="file" id="photo${i.count}" name="file" accept="image/*" style="width: 100%; visibility: hidden;" onchange="uploadOnChange(this)">
...
<%--                                        <button type="submit" class="myButton" id="uploadButton${i.count} style="display:none;">upload</button> --%>
						...
						<div class="row">
							...
							<div class="col-sm-2">
								<a href="/update" class="btn btn-lg btn-lg-square"
									style="background-color: pink; width: 100%; height: 40px;">
                  ...
                  <!-- Back to Top -->
<!--                   <a href="#"
                     class="btn btn-lg btn-primary btn-lg-square back-to-top" style="background: pink; border-color: pink;"><i
